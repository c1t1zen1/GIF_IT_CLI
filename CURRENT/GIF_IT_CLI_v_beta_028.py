...
def main():
    ...
    parser.add_argument('-dissolve', type=int, default=0, help='The number of frames to use for the dissolve effect between each image.')
    ...
    parser.add_argument('-font', type=str, default='impact.ttf', help='C:/Windows/Fonts/')
